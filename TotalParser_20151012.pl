...
$MTC_format[37] = [1, "redirecting_number_ton", "HEX"];
$MTC_format[38] = [12, "redirecting_number", "HEX"];
...
$ROAM_format[28] = [1, "redirecting_number_ton", "HEX"];
$ROAM_format[29] = [12, "redirecting_number", "HEX"];
...
$POC_format[19] = [4, "idle_duration_ten_ms", "HEX"];
$POC_format[20] = [4, "addr_complete_duration_ten_ms", "HEX"];
$POC_format[21] = [1, "redirecting_number_ton", "HEX"];
$POC_format[22] = [12, "redirecting_number", "HEX"];
...
$PTC_format[19] = [4, "idle_duration_ten_ms", "HEX"];
$PTC_format[20] = [4, "addr_complete_duration_ten_ms", "HEX"];
$PTC_format[21] = [1, "redirecting_number_ton", "HEX"];
$PTC_format[22] = [12, "redirecting_number", "HEX"];
...
$PBXO_format[19] = [1, "redirecting_number_ton", "HEX"];
$PBXO_format[20] = [12, "redirecting_number", "HEX"];
...
$PBXT_format[19] = [1, "redirecting_number_ton", "HEX"];
$PBXT_format[20] = [12, "redirecting_number", "HEX"];
...
$UCA_format[18] = [4, "setup_duration_ten_ms", "HEX"];
...
while(read(DX200_FILE, $buf, $lead_rec_size)) {
    ...
    if ($rec_type eq "ff") { 
        print "FF block header found. Counted as padding.\n";
        last;
    }
...
# version
# 1.1.5 - fix FF padding
# 1.1.4 - updated format
